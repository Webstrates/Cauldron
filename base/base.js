...
class CauldronBase {
    ...
    */
    ...
    setupDragAndDrop() {
        ...
        EventSystem.registerEventCallback("TreeBrowser.TreeNode.Dropped", ({detail: { draggedNode: draggedNode, droppedNode: droppedNode, dropEffect: dropEffect}})=>{
            if(draggedNode.type === "DomTreeNode" && droppedNode.type === "DomTreeNode" && !droppedNode.context.matches("code-fragment")) {
                try {
                    if(dropEffect === "move") {
                ...
                if(evt.dataTransfer.types.includes("Files")) {
                    ...
                    if (dragged != null && dragged.treeNode != null) {
                        ...
                        if(dragged.treeNode.type === "DomTreeNode" ) {
                            if(!node.context.matches("code-fragment, wpm-package") && node.context.closest("wpm-package") == null) {
